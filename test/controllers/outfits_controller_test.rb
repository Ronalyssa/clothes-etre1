...
class OutfitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create outfit" do
    assert_difference('Outfit.count') do
      post outfits_url, params: { outfit: { bottom_id: @outfit.bottom_id, name: @outfit.name, top_id: @outfit.top_id, user_id: @outfit.user_id } }, as: :json
    end
  ...
  test "should update outfit" do
    patch outfit_url(@outfit), params: { outfit: { bottom_id: @outfit.bottom_id, name: @outfit.name, top_id: @outfit.top_id, user_id: @outfit.user_id } }, as: :json
    assert_response 200
  end
